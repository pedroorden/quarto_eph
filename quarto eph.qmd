---
title: "Utilizando Python y R en Quarto"
subtitle: "Integración práctica aplicada a la EPH (INDEC)"
author: "Lic. Pedro Damián Orden*"
date: "6/21/2022"
format:
  html:
    theme: materia
...
[![Günther Förg, Hommage à Le Corbusier (2000).](www/frog.jpg "Günther Förg, Hommage à Le Corbusier, 2000, acrylic on paper, 23 parts, each 50 x 38 cm.")](https://www.debrockgallery.com/artists/gunther-forg)

### Presentación

El presente documento es un preliminar material de trabajo, creado a partir de los [diálogos de innovación](https://www.nucleodeinnovacion.com/post/di%C3%A1logos-de-innovaci%C3%B3n) llevados adelante por el [**NIS**](https://www.nucleodeinnovacion.com/) durante 2022, y tiene como objetivo dar cuenta de una experiencia de **integración** de lenguajes de programación aplicados al procesamiento de la Encuesta Permanente de Hogares (EPH de [INDEC](https://www.indec.gob.ar/)), posible gracias [**Quarto**](https://quarto.org/), un sistema de publicación científica y técnica basado en Pandoc[^1] que funciona de manera amigable con Rstudio[^2].
...
datosehp.to_csv('data/eph2021.csv')
```
...
```{r}
eph2021<-read.csv("data/eph2021.csv")
```
...
El repositorio completo para recrear este documento puede encontrarse en [**github**](https://github.com/pedroorden/quarto.eph).

\*[Sociólogo y Científico de Datos](https://portfolioprofesional.netlify.app/ "portfolio").
